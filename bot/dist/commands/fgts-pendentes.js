    ...
    async execute(interaction) {
        ...
        try {
            ...
            if (pendentes.length === 0) {
                await interaction.editReply({
                    embeds: [createSuccessEmbed('Todos em Dia!', `Todos os **${membrosAtivos.length}** membros ja pagaram o FGTS de **${nomeMes}/${ano}**!`)]
                });
                return;
            }
            // Cria o embed
            const embed = new EmbedBuilder()
                ...
                .setDescription(`**${pendentes.length}** de **${membrosAtivos.length}** membros ainda nao pagaram o FGTS.\n\n` +
...
//# sourceMappingURL=fgts-pendentes.js.map