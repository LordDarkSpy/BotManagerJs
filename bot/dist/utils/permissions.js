 ...
 */
export async function canApproveSet(member, guildId) {
 ...
 */
export async function canManageCargos(member, guildId) {
    // Administradores sempre podem
    if (member.permissions.has(PermissionFlagsBits.Administrator)) {
        return true;
    }
 ...
 */
export async function isBotAdmin(member, guildId) {
 ...
 */
export async function canChangeMemberCargo(executor, alvo, guildId) {
 ...
 */
export async function canSetCargo(executor, cargoId, guildId) {
 ...
 */
export async function checkBlacklist(discordId, guildId) {
 ...
 */
export async function getMembro(discordId, guildId) {
 ...
 */
export async function hasPendingSetRequest(discordId, guildId) {
