import { ChatInputCommandInteraction, ButtonInteraction, ModalSubmitInteraction, StringSelectMenuInteraction, SlashCommandBuilder, SlashCommandOptionsOnlyBuilder, Client, Collection } from 'discord.js';
/**
 ...
 */
export type BotInteraction = ChatInputCommandInteraction | ButtonInteraction | ModalSubmitInteraction | StringSelectMenuInteraction;
/**
 ...
 */
export type LogAction = 'SET_SOLICITADO' | 'SET_APROVADO' | 'SET_REPROVADO' | 'CARGO_ALTERADO' | 'CARGO_CRIADO' | 'CARGO_REMOVIDO' | 'AUSENCIA_REGISTRADA' | 'AUSENCIA_FINALIZADA' | 'FGTS_PAGO' | 'BLACKLIST_ADICIONADO' | 'BLACKLIST_REMOVIDO' | 'MEMBRO_BANIDO' | 'MEMBRO_DESBANIDO' | 'CONFIG_ALTERADA' | 'PUNICAO_APLICADA' | 'PUNICAO_REMOVIDA';
/**
...
export declare const EmbedColors: {
    ...
    readonly INFO: 39423;
    readonly PENDING: 16750848;
    readonly NEUTRAL: 8421504;
 ...
 */
export declare function parseButtonId(customId: string): ParsedButtonId;
