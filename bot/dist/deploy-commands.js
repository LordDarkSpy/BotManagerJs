...
async function deployCommands() {
    ...
    try {
        ...
        if (guildId) {
            ...
            data = await rest.put(Routes.applicationGuildCommands(clientId, guildId), { body: commandsData });
        }
        else {
            console.log('🌐 Registrando comandos globalmente...');
            data = await rest.put(Routes.applicationCommands(clientId), { body: commandsData });
        }
        console.log('='.repeat(50));
